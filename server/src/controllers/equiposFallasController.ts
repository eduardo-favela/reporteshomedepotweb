...
class EquiposFallasController {
    ...
    public async getEquipos(req: Request, res: Response){
        await db.query(`select * from equipo_pv`, function(err, result, fields){
            if(err) throw err
            res.json(result)
        })
        //res.json({message: 'ok'})
    ...
    public async registraReporte(req: Request, res: Response){
        await db.query(`INSERT INTO reportes set ?`,[req.body],function(err, result, fields){
            if(err) throw err
            res = res.json(result)
        })
    }
    ...
    public async registraEquipo(req: Request, res: Response){
        await db.query(`INSERT INTO detalle_reportes_fallas set ?`,[req.body],function(err, result, fields){
            if(err) throw err
            res = res.json(result)
        })
    }
    ...
    public async getEstatusReporte(req: Request, res: Response){
        await db.query(`SELECT * FROM estatus_reporte`,function(err, result, fields){
            if(err) throw err
            res = res.json(result)
        })
    }
    ...
    public async updateEstatusRep(req: Request, res: Response){
        await db.query(`UPDATE reportes SET estatus_reporte_id = ? WHERE idreporte = ?`,[req.body.estatus_reporte,req.body.idreporte],function(err, result, fields){
            if(err) throw err
            res = res.json(result)
        })
    }
    ...
    public async registraComentarios(req: Request, res: Response){
        await db.query(`INSERT INTO comentarios_reportes set ?`,[req.body],function(err, result, fields){
            if(err) throw err
            res = res.json(result)
        })
    }
